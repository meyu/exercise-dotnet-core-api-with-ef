...
namespace exercise_dotnet_core_api_with_ef.Controllers
{
    ...
    public class CourseInstructorsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<CourseInstructor>> GetCourseInstructor(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCourseInstructor(long id, CourseInstructor courseInstructor)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<CourseInstructor>> DeleteCourseInstructor(long id)
        {
            var courseInstructor = await _context.CourseInstructor.FindAsync(id);
            if (courseInstructor == null)
            {
        ...
        private bool CourseInstructorExists(long id)
        {
