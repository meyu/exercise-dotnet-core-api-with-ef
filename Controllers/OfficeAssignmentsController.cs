...
namespace exercise_dotnet_core_api_with_ef.Controllers
{
    ...
    public class OfficeAssignmentsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<OfficeAssignment>> GetOfficeAssignment(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutOfficeAssignment(long id, OfficeAssignment officeAssignment)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<OfficeAssignment>> DeleteOfficeAssignment(long id)
        {
            var officeAssignment = await _context.OfficeAssignment.FindAsync(id);
            if (officeAssignment == null)
            {
